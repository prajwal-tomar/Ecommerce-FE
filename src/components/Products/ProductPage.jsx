...
export default function ProductPage() {
    ...
    const handleFilter = (value, sectionId) => {
        // Correctly instantiate URLSearchParams
        ...
        if (filterValues.length > 0 && filterValues[0].split(",").includes(value)) {
            ...
            if (filterValues.length === 0) {
                // If the array is empty, delete the parameter
                searchParams.delete(sectionId);
            } else {
                // Otherwise, update the parameter with the new array
    ...
    return (
        <div className="bg-white">
            <div>
                ...
                <main className="mx-auto px-10 sm:px-6 lg:px-20">
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                            ...
                            <form className="hidden lg:block">
                                <div className='flex justify-between items-center'>
                                    <h3 className='font-bold text-lg text-slate-700'>Filters</h3>
                                    <IoFilterSharp />
                                </div>
                                {filters.map((section) => (
